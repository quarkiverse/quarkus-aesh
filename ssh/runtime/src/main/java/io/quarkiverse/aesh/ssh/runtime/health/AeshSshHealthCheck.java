package io.quarkiverse.aesh.ssh.runtime.health;
...
import io.quarkiverse.aesh.ssh.runtime.AeshSshConfig;
    ...
    public HealthCheckResponse call() {
        ...
        if (sshServer.isRunning()) {
            return builder.up()
                    ...
                    .withData("activeConnections", sshServer.getActiveConnectionCount())
                    .build();
        } else {
            return builder.down()
